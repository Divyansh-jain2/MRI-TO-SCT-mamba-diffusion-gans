...
# Configuration file
parser = argparse.ArgumentParser(description="Train Pix2Pix on prepared 2D MR/CT slice CSVs.")
parser.add_argument("--config", default="./configs/pix2pix_train.yaml", help="Path to the Pix2Pix training YAML file.")
