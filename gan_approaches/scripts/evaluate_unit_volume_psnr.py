...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Compute UNIT volume-level PSNR from saved per-slice outputs (no retraining)."
    )
    parser.add_argument("--config", default="configs/unit_train.yaml", help="Path to UNIT training YAML.")
    ...
    print("=" * 72)
    print(f"UNIT volume-level PSNR | fold={args.fold} split={args.split} | mapping={args.hu_mapping}")
